...
class EditProfile extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        if(nextProps.profile.profile) {
            ...
            profile.linkdin = !isEmpty(profile.linkdin) ? profile.linkdin : '';
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            <h1 className="displlay-4 text-center">Edit Profile</h1>
                            ...
                            <form onSubmit={this.onSubmit}>
                                ...
                                <TextFieldGroup
                                    ...
                                    info="Could be your own compny or one you work for"
                                />
                                <TextFieldGroup
                                    placeholder="Website"
                                    name="website"
